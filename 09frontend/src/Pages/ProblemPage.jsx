  ...
  useEffect(() => {
    const fetchProblem = async () => {
      ...
      try {
        ...
        console.log("API Response:", problemData);

        // Check if startCode exists and is an array
        if (!problemData.startCode || !Array.isArray(problemData.startCode)) {
          console.error(
            "startCode is missing or not an array:",
            problemData.startCode
          );
          setCode("// Error: No starter code available for this problem");
        } else {
          // Find initial code for the selected language
          ...
          console.log("startCode Array:", problemData.startCode);

          if (!startCodeEntry) {
            console.error(
              `No initial code found for language: ${selectedLanguage}`
            );
            setCode(`// No starter code available for ${selectedLanguage}`);
          } else {
        ...
        setCode("// Error: Failed to load starter code");
        setLoading(false);
      }
    };
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="p-4 border-t border-base-300 flex justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    className={`btn btn-primary btn-sm  bg-amber-400 text-black border-0${
                      loading ? "loading" : ""
                    }`}
